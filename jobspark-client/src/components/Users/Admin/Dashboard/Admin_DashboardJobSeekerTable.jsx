  ...
  return (
    <React.Fragment>
      ...
      >
        ...
        <TableCell className="border-0 text-gray-500">{row.lastSignIn}</TableCell>
        <TableCell className="border-0">
        ...
        <Table stickyHeader className="min-w-full">
          <TableHead>
            <TableRow className="bg-gray-50">
              ...
              <TableCell className="border-0 font-medium">Location</TableCell>
              <TableCell className="border-0 font-medium">Status</TableCell>
              <TableCell className="border-0 font-medium">Last Active</TableCell>
          ...
          <TableBody>
            {data
              ...
              .map((row, index) => (
                <UserRow key={`${row.name}-${index}`} row={row} />
              ))}
          </TableBody>
        </Table>
      </TableContainer>
...
Admin_DashboardJobSeekerTable.propTypes = {
  data: PropTypes.array.isRequired,
  title: PropTypes.string.isRequired
};

export default Admin_DashboardJobSeekerTable;