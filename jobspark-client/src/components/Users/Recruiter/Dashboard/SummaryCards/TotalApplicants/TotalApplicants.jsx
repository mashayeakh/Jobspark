...
const TotalApplicants = () => {
    ...
    const { appliedInfo } = useContext(TotalApplicationContext);
            ...
            <div className="p-6 bg-gray-50 min-h-screen">
                <div>
                    ...
                    <h2 className="text-2xl font-bold mb-6 text-gray-800">
                        Total Applications: <span className="text-blue-600">{showDataInfo.data?.numOfApplicants?.length || 0}</span>
                    </h2>
                    <div className="grid grid-cols-1 md:grid-cols-4 gap-6 mb-8">
                        <div className="bg-white rounded-xl shadow-lg p-6 flex flex-col items-center">
                            ...
                            <span className="text-2xl font-bold text-blue-600">{showDataInfo.data?.numOfApplicants?.length || 0}</span>
                        </div>
                        <div className="bg-white rounded-xl shadow-lg p-6 flex flex-col items-center">
                            <img src={Google} alt="Company Logo" className="w-12 mb-3" />
