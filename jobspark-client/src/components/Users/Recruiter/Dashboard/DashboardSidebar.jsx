        ...
        <aside className={`bg-white shadow-xl min-h-full overflow-y-auto overflow-x-hidden transition-all duration-300 ${collapsed ? 'w-20' : 'w-64'}`}>
            ...
            <div className="p-4">
                ...
                <ul className="space-y-2 font-medium">
                    ...
                    {/* Kanban */}
                    <li>
                        <Link to="/recruiter/dashboard/application-graph" className="flex items-center p-2 text-gray-900 rounded-lg hover:bg-gray-100 group">
                            ...
                            {/* {!collapsed && <span className="px-2 ms-3 text-sm font-medium text-gray-800 bg-gray-100 rounded-full">Pro</span>} */}
                        </Link>
                    </li>

                    {/* Inbox */}
                    <li>
                        <Link to="/recruiter/dashboard/inbox" className="flex items-center p-2 text-gray-900 rounded-lg hover:bg-gray-100 group">
                            ...
                            {!collapsed && <span className="w-5 h-5 ms-3 text-xs font-medium text-blue-800 bg-blue-100 rounded-full flex items-center justify-center">3</span>}
                        </Link>
                    </li>

                    {/* Users */}
                    <li>
                        <Link to="/recruiter/dashboard/latest-applicants" className="flex items-center p-2 text-gray-900 rounded-lg hover:bg-gray-100 group">
                    ...
                    <li>
                        <a href="#" className="flex items-center p-2 text-gray-900 rounded-lg hover:bg-gray-100 group">
                            <svg className="w-5 h-5 text-gray-500 group-hover:text-gray-900" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 18 20">
                                <path d="M17 5.923A1 1 0 0 0 16 5h-3V4a4 4 0 1 0-8 0v1H2a1 1 0 0 0-1 .923L.086 17.846A2 2 0 0 0 2.08 20h13.84a2 2 0 0 0 1.994-2.153L17 5.923ZM7 9a1 1 0 0 1-2 0V7h2v2Zm0-5a2 2 0 1 1 4 0v1H7V4Zm6 5a1 1 0 1 1-2 0V7h2v2Z" />
                            </svg>
                            {!collapsed && <span className="flex-1 ms-3">Notifications</span>}
                        </a>
                    </li>
                </ul>
            </div>
