...
| **Premium Recruiter** | `jane@techcorp.com` | `Password123!` | Job post wizard, candidate tracking pipeline, smart interview scheduler, and applicant analysis panel. |
...
npm run dev
```
*The web interface will boot up locally at:* `http://localhost:3000`
...
---
*JobSpark is licensed under the MIT License. Built with ❤️ for premium talent matching.*
