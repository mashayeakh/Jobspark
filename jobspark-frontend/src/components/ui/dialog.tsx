...
function DialogHeader({
  ...
  return (
    <div
      ...
      className={cn("flex flex-col gap-1.5 text-center sm:text-left px-8 py-6 border-b", className)}
      {...props}
    />
  )
}
