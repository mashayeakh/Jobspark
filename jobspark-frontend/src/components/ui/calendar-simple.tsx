...
const SimpleCalendar = React.forwardRef<HTMLDivElement, SimpleCalendarProps>(
            ...
            <div key={index} className="aspect-square">
              {date && (
                <button
                  ...
                  className={`w-full h-full p-2 text-sm rounded hover:bg-gray-100 focus:outline-none focus:ring-2 focus:ring-blue-500 ${
                    isDateSelected(date) 
