        ...
        <Breadcrumb>
          <BreadcrumbList>
            <BreadcrumbItem className="hidden md:block">
              <BreadcrumbLink href="/recruiter" className="text-slate-500 hover:text-[#4880FF] transition-colors">Recruiter</BreadcrumbLink>
            </BreadcrumbItem>
            <BreadcrumbSeparator className="hidden md:block">
              <ChevronRight className="h-4 w-4 text-slate-400" />
            </BreadcrumbSeparator>
            <BreadcrumbItem>
              <BreadcrumbPage className="font-semibold text-slate-900">Settings</BreadcrumbPage>
            </BreadcrumbItem>
          </BreadcrumbList>
        </Breadcrumb>
      </header>
      ...
      <main className="flex-1 p-6 md:p-8 max-w-7xl mx-auto w-full animate-in fade-in slide-in-from-bottom-4 duration-500">
        <div className="mb-8">
          <div className="flex items-center gap-3 mb-1">
             <Settings className="h-8 w-8 text-[#4880FF]" />
             <h1 className="text-3xl font-extrabold tracking-tight text-slate-900">Settings</h1>
          </div>
          <p className="text-slate-500 text-lg">Manage your account preferences and personal information</p>
        </div>
