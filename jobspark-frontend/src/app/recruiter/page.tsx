...
const RecruiterPage = () => {
    ...
    const stats = [
        { value: isLoading ? '...' : `${counters.jobSeekers}`, label: 'Active Candidates' },
        { value: isLoading ? '...' : `${counters.companies}`, label: 'Partner Companies' },
            ...
            <section className="py-20 bg-gradient-to-r from-green-600 to-blue-700 text-white">
                <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
                    ...
                    <div className="flex justify-center">
                        <button
                            onClick={handlePostJobClick}
                            className="px-8 py-4 bg-white text-green-600 font-semibold rounded-xl hover:bg-gray-100 transition-all duration-300 transform hover:scale-105 flex items-center justify-center gap-2 shadow-lg hover:shadow-xl"
                        >
                            Post Your First Job
                            <Briefcase className="w-5 h-5" />
                        </button>
